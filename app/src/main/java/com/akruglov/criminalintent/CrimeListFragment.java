...
public class CrimeListFragment extends Fragment {
    ...
    private class CrimeHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public CrimeHolder(View itemView) {
            ...
            mTitleTextVew = (TextView) itemView.findViewById(R.id.list_item_crime_title_text_view);
        ...
        public void bindCrime(Crime crime, int position) {
            ...
            mTitleTextVew.setText(mCrime.getTitle());
        ...
        public void onClick(View v) {
            Intent intent = CrimePagerActivity.newIntent(getActivity(), mCrime.getId(), mCrimePosition);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menu_item_new_crime:
                ...
                int position = CrimeLab.get(getActivity()).getCrimeIndex(crime);
